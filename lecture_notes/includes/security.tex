...
We have that 
\begin{eqnarray*}
\mathbb{P}(\tau_u = t_k) &=& \mathbb{P}\left(\bigcap_{l = 1}^{k}\{T_l\leq t_l\}\cap\{T_{k+1}> t_k\}\right)\\
&=& \mathbb{P}\left(\bigcap_{l = 1}^{k-1}\{T_l\leq t_l\}\cap\{N_{t_k} = k\}\right)\\
&=& \mathbb{P}\left(\bigcap_{l = 1}^{k-1}\{T_l\leq t_l\}|N_{t_k} = k\right)\mathbb{P}(N_{t_k} = k)
\end{eqnarray*}
\end{enumerate}
