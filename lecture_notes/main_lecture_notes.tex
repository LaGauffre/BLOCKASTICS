...
\input{includes/consensus_protocol}
\input{includes/security}
\input{includes/decentralization}
...
% \input{includes/montant_sinistres}
% \input{includes/inference_bayesienne}
% % \include{includes/selection_bayesienne}
% \input{includes/simulation}
% \input{includes/aus_data}
