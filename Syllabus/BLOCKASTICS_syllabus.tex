...
% %Course page: Includes overview of the course like the syllabus, office hours, homework information, etc.\\  \hspace*{.75in}\courseWebpage\\  
% GauchoSpace:  Includes course announcements, homework, lecture material, the course calendar, and up-to-date information about your grades.\\ \hspace*{.75in}\href{http://gauchospace.ucsb.edu}{gauchospace.ucsb.edu}\\  
